...
alias nas-connect='sudo mount -t cifs -o username=mhermann,password=### //141.37.176.190/Studies/Hermann_M /mnt/NAS -o vers=1.0'
...
# GHOSTSCRIPT
alias pdf-merge="gs -dNOPAUSE -sDEVICE=pdfwrite -sOUTPUTFILE=merged.pdf -dBATCH"
alias pdf-split="gs -sDEVICE=pdfwrite -dSAFER -o outname.%d.pdf"
